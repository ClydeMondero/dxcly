...
(9, 'FUTURISTIC HOODIE', 'assets\\hoodies\\futuristic-hoodie-techwear-574_540x.jpg', 6499, 'Hoodies', 'Discover a garment that pushes the boundaries of contemporary fashion. Our Futuristic Hoodie offers more than just warmth and comfort, it offers a taste of what\'s to come in the realms of techwear and futuristic design. This futuristic hoodie is available ', 12),
...
(45, 'BEST TECHWEAR SHOES', 'assets\\footwear\\best-techwear-shoes-techwear-404_360x.jpg', 6999, 'Footwear', 'These functional shoes are an essential element to achieve your style. Complementing your cargo pants and techwear t-shirt, this pair of shoes will add a futuristic and design touch to your outfit.', 15),
...
(50, 'JAPANESE BASEBALL CAP', 'assets\\hats\\japanese-baseball-cap-techwear-170_360x.jpg', 3499, 'Hats', 'This Japanese baseball cap is made of cotton and polyester. It is equipped with eyelets to let the air circulate while protecting you effectively from the rain and the sun with its visor. This snapback cap adapts easily to all heads with its adjustable str', 15),
...
(62, 'GREEN ARMY TACTICAL GLOVES', 'assets\\gloves\\green-army-tactical-gloves-techwear-428_360x.jpg', 3499, 'Gloves', 'Experience the epitome of versatility, protection, and tactical efficiency with our premium Green Army Tactical Gloves. Designed to meet the specific needs of military personnel, outdoor adventurers, or to enhance your warcore style, these gloves set a new', 15),
(63, 'CAMO TACTICAL GLOVES', 'assets\\gloves\\camo-tactical-gloves-techwear-554_360x.jpg', 3499, 'Gloves', 'Specially designed for individuals who won\'t settle for anything less than the best, these gloves combine advanced functionality with an unbeatable camo design. The high-quality fabric used in their construction provides a robust yet flexible structure, en', 15),
...
(66, 'CYBERPUNK BACKPACK', 'assets\\backpacks\\cyberpunk-backpack-techwear-220_360x.jpg', 6999, 'Backpacks', 'In the ever-evolving landscape of modern fashion, the cyberpunk backpack emerges as a testament to the blend of technology and avant-garde aesthetics. With a design that screams \"future,\" this backpack effortlessly captures the essence of a world where fas', 15);
